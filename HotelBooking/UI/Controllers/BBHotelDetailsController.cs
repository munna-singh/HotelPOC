    ...
    public class BBHotelDetailsController : Controller
    {
        ...
        public ActionResult Index(FormCollection collection)
        {
            ...
            if (status != null && status.error == null)
            {
                ...
                //ar.hotels = new HotelsFilter();
                //ar.hotels.hotel = new List<int>();
                //ar.hotels.hotel.Add();
                ...
                //ar.geolocation.latitude = Convert.ToDouble(collection["lat"]);
                //ar.geolocation.longitude = Convert.ToDouble(collection["lan"]);
